const firebaseConfig = {
  ...
  var contactFormDB = firebase.database().ref("mechanicform");
  
  document.getElementById("mechanicform").addEventListener("submit", submitForm);
  ...
  function submitForm(e) {
    ...
    saveMessages(fullname, location, number,description);
  ...
  const saveMessages = (fullname, location, number,description) => {
